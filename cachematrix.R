## The Complex operations can take a long time to compute and programing like matrix invertion 
## If we use this operations several is is not necessary to calculate again and again
...
## This code is written for Programming Assignment 2 - R programming 
...
cacheSolve <- function(x, ...) {
        ...
        ## following code gets the original matrix data, stores its inverse "i"
